...
class CustomerSignUpForm(UserCreationForm):
    ...
    #mail = forms.EmailField(required=True, label="Email", widget=forms.EmailInput , attrs={'placeholder': 'Enter your Email'})
    #password1 = forms.CharField(required=True, label="Password", widget=forms.PasswordInput , attrs={'placeholder': 'password'})
    #password2 = forms.CharField(required=True, label="Password", widget=forms.PasswordInput , attrs={'placeholder': 'password'})
